...
- Active chunk: `Task 2b` - board view-model mapping rules
- Next chunk: `Task 3a` - symbolic board component and page integration
...
- Last completed chunk: `Task 2a` - snapshot contract audit (2026-03-14)
